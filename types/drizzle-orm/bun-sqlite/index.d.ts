...
type BunSQLiteDatabase = BaseSQLiteDatabase<'sync', void>;
declare function drizzle(client: Database, config?: DrizzleConfig): BunSQLiteDatabase;
...
declare class PreparedQuery<T extends PreparedQueryConfig = PreparedQueryConfig> extends PreparedQuery$1<{
    ...
    private logger;
    private fields;
    constructor(stmt: Statement, queryString: string, params: unknown[], logger: Logger, fields: SelectedFieldsOrdered | undefined);
...
export { BunSQLiteDatabase, DrizzleConfig, PreparedQuery, SQLiteBunSession, SQLiteBunSessionOptions, drizzle };
