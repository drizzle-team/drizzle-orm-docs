...
declare class BetterSQLiteSession extends SQLiteSession<'sync', RunResult> {
    private client;
    private logger;
    ...
    transaction(): Transaction<'sync', RunResult>;
}
...
export { BetterSQLite3Database, BetterSQLiteSession, BetterSQLiteSessionOptions, DrizzleConfig, PreparedQuery, drizzle };
