...
declare class MySql2Session extends MySqlSession {
    private client;
    private logger;
...
type MySql2Database = MySqlDatabase<MySql2QueryResultHKT, MySql2Session>;
declare function drizzle(client: MySql2Client, config?: DrizzleConfig): MySql2Database;

export { DrizzleConfig, MySql2Client, MySql2Database, MySql2Driver, MySql2PreparedQuery, MySql2QueryResultHKT, MySql2Session, MySqlDatabase, MySqlDriverOptions, MySqlQueryResult, MySqlQueryResultType, MySqlRawQueryResult, NodePgSessionOptions, drizzle };
