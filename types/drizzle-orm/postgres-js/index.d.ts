import { Sql, RowList, Row } from 'postgres';
...
declare class PostgresJsSession extends PgSession {
    client: Sql;
    logger: Logger;
...
type PostgresJsDatabase = PgDatabase<PostgresJsQueryResultHKT, PostgresJsSession>;
declare function drizzle(client: Sql, config?: DrizzleConfig): PostgresJsDatabase;

export { DrizzleConfig, PostgresJsDatabase, PostgresJsPreparedQuery, PostgresJsQueryResultHKT, PostgresJsSession, PostgresJsSessionOptions, drizzle };
