...
declare class SQLiteRemoteSession extends SQLiteSession<'async', SqliteRemoteResult> {
    ...
    transaction(transaction: (tx: Transaction<'async', SqliteRemoteResult>) => void | Promise<void>): Promise<void>;
}
...
export { AsyncRemoteCallback, DrizzleConfig, PreparedQuery, RemoteCallback, SQLiteRemoteSession, SQLiteRemoteSessionOptions, SqliteRemoteDatabase, SqliteRemoteResult, drizzle };
