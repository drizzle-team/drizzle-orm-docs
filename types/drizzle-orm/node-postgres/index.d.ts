...
type NodePgClient = Pool | PoolClient | Client;
...
declare class NodePgSession extends PgSession {
    private client;
    private logger;
...
type NodePgDatabase = PgDatabase<NodePgQueryResultHKT, NodePgSession>;
declare function drizzle(client: NodePgClient, config?: DrizzleConfig): NodePgDatabase;

export { DrizzleConfig, NodePgClient, NodePgDatabase, NodePgDriver, NodePgPreparedQuery, NodePgQueryResultHKT, NodePgSession, NodePgSessionOptions, PgDriverOptions, drizzle };
