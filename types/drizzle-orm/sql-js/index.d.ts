...
type SQLJsDatabase = BaseSQLiteDatabase<'sync', void>;
declare function drizzle(client: Database, config?: DrizzleConfig): SQLJsDatabase;

interface SQLJsSessionOptions {
    logger?: Logger;
}
type PreparedQueryConfig = Omit<PreparedQueryConfig$1, 'statement' | 'run'>;
declare class SQLJsSession extends SQLiteSession<'sync', void> {
    private client;
    private logger;
    ...
    prepareOneTimeQuery<T extends Omit<PreparedQueryConfig, 'run'>>(query: Query, fields?: SelectedFieldsOrdered): PreparedQuery<T>;
    transaction(): Transaction<'sync', void>;
}
declare class PreparedQuery<T extends PreparedQueryConfig = PreparedQueryConfig> extends PreparedQuery$1<{
    ...
    constructor(stmt: Statement, queryString: string, params: unknown[], logger: Logger, fields: SelectedFieldsOrdered | undefined, isOneTimeQuery?: boolean);
...
export { DrizzleConfig, PreparedQuery, SQLJsDatabase, SQLJsSession, SQLJsSessionOptions, drizzle };
