...
declare class NeonSession extends PgSession {
    private client;
    private logger;
...
type NeonDatabase = PgDatabase<NeonQueryResultHKT, NeonSession>;
declare function drizzle(client: NeonClient, config?: DrizzleConfig): NeonDatabase;

export { DrizzleConfig, NeonClient, NeonDatabase, NeonDriver, NeonDriverOptions, NeonPreparedQuery, NeonQueryResultHKT, NeonSession, NeonSessionOptions, drizzle };
