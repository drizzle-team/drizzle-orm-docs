...
> **Info**: For more advanced documentation about defining custom data types in PostgreSQL and MySQL please check [custom types advanced](./custom-types/custom-types-advanced)
