...
The best way to see how the `customType` definition works is to check how existing data types in postgres and mysql could be defined using `customType` function from Drizzle ORM.
