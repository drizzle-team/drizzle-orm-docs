...
through their official [`database-js`](https://github.com/planetscale/database) 
...
Make sure to checkout PlaneScale official [MySQL courses](https://planetscale.com/courses/mysql-for-developers/examples/introduction-to-examples), 
