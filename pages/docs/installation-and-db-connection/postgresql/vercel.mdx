...
Due to their [official website](https://vercel.com/docs/storage/vercel-postgres),
...
Setup project due to their [official docs](https://vercel.com/docs/storage/vercel-postgres/quickstart)  
