...
Drizzle ORM provides you with an API for declaring SQL schemas for PostgreSQL and MySQL dialects.

If you declare a table within a schema, the query builder will prepend schema names in queries: `select * from "schema"."users"`
