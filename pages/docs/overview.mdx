...
there're certain common scenarios when you can query data in a better way.  
  
We've built [Queries API](/docs/rqb) for you, so you can fetch relational nested data from database 
