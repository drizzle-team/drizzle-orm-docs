...
We truly believe that it's a misconception based on legacy nomenclature and we call them **data frameworks**.
...
Other ORMs and data frameworks tend to deviate or abstract you away from SQL, which leads to a double learning curve — needing to know both SQL and the framework's API.  
  
Drizzle is the opposite. We embrace SQL and built Drizzle to be SQL-like at its core, so you can have little to no learning curve and have access to the full power of SQL.  
...
in the most convenient and performant way, and never think about joins and data mappings.  
...
We've spent a lot of time to make sure you have the best-in-class SQL dialects support — Postgres, MySQL, or any other dialect-specific stuff.
  
Drizzle operates natively through industry standard database drivers. We support all major drivers for **[PostgreSQL](/docs/quick-postgresql)**, **[MySQL](/docs/quick-mysql)** and **[SQLite](/docs/quick-sqlite)** and we're adding new ones **[really fast](https://twitter.com/DrizzleORM/status/1653082492742647811?s=20)**.  
