...
It looks and feels simple, will perform on day 1000 of your project, 
it will let you do things your way and help when you need help  
...
[automatic migrations](/docs/migrations) and [one more thing](/docs/queries).

<CodeTabs items={["index.ts", "schema.ts", "migration.sql"]}>
```typescript copy
// Access your data
import { drizzle } from 'drizzle-orm/postgresjs';
import * as schema, { countries } from './schema'

const db: NodePgDatabase = drizzle(..., { schema });
...
We have an outstanding [Discord community](https://driz.li/discord) and welcome to our [Twitter](twitter.com/drizzleorm)  
