...
and whatever we do not yet support can be done with our powerful **[`sql`](/docs/sql)** operator.
...
## WITH clause
SQL `with` clause is a statement scoped view, helpful to organise complex queries like such:
<Section>
```typescript copy
