...
Join clause is used to combine 2 or more tables, based on related columns between them.  
  
We embrace each dialect and implemented full list of dialect-available join types.  
