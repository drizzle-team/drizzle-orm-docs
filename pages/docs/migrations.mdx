...
**[Drizzle Kit](/kit-docs)** — a CLI companion for DrizzleORM, it lets you generate SQL statements for schema creation and alterations 
or apply changes directly to the database.  
  
See our detailed **[docs](/kit-docs)** for extended examples and walkthroughs.
