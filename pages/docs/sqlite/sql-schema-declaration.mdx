...
This is how you declare SQL schema in `schema.ts`. You can declare tables, indexes and constraints and foreign keys. Please pay attention to `export` keyword, they are mandatory if you'll be using [drizzle-kit SQL migrations generator](./migrations).
