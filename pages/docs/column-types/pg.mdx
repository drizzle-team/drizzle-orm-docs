...
Official PostgreSQL [docs](https://www.postgresql.org/docs/current/datatype-numeric.html#DATATYPE-SERIAL)  
<Section>
```typescript
...
Official PostgreSQL [docs](https://www.postgresql.org/docs/current/datatype-boolean.html)  
...
Official PostgreSQL [docs](https://www.postgresql.org/docs/current/datatype-character.html)  
...
Official PostgreSQL [docs](https://www.postgresql.org/docs/current/datatype-numeric.html#DATATYPE-NUMERIC-DECIMAL)  
<Section>
```typescript
...
Official PostgreSQL [docs](https://www.postgresql.org/docs/current/datatype-numeric.html)  
...
Official PostgreSQL [docs](https://www.postgresql.org/docs/current/datatype-json.html)
<Section>
```typescript
import { sql } from "drizzle-orm";
