...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-numeric.html#DATATYPE-SERIAL)**
<Section>
```typescript
...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-boolean.html)**
...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-character.html)**
...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-numeric.html#DATATYPE-NUMERIC-DECIMAL)**
...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-numeric.html)**  
...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-json.html)**
<Section>
```typescript
import { sql } from "drizzle-orm";
...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-datetime.html)**
...
For more info please refer to the official PostrgreSQL **[docs.](https://www.postgresql.org/docs/current/datatype-enum.html)**
<Section>
```typescript
