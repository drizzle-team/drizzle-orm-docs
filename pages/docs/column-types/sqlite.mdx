...
// you can customize integer mode be number, boolean, timestamp, timestamp_ms
...
Since there is no `boolean` data type in SQLite, Drizzle offers a special `boolean` mode for `integer` columns. 
This mode allows you to work with boolean values in your code, and Drizzle stores them as 0 and 1 integer
