...
<Cards>
  <Card title="PostgreSQL column types" href="/docs/column-types/pg" />
  <Card title="MySQL column types" href="/docs/column-types/mysql" />
  <Card title="SQLite column types" href="/docs/column-types/sqlite" />
</Cards>