...
almost 0 overhead and to make it actually 0, you can utilise our prepared statements API.
...
Different database drivers support prepared statements in different ways and sometimes, with Drizzle ORM, you can go [**faster than better-sqlite3 driver.**](https://twitter.com/_alexblokh/status/1593593415907909634)
