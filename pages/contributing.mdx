import nodeInstallation from '../scripts/contributing/nodeinstallation.json';
import pnpmInstallation from '../scripts/contributing/pnpminstallation.json';
import dockerInstallation from '../scripts/contributing/dockerinstallation.json';
import cloneProject from '../scripts/contributing/cloneproject.json';
import buildProject from '../scripts/contributing/buildproject.json';
import testProject from '../scripts/contributing/testproject.json';
...
<SmallTerminal data={nodeInstallation} height={'64px'}/>

### <a name="installing-pnpm"></a> Install pnpm
---

<SmallTerminal data={pnpmInstallation} height={'32px'}/>

### <a name="installing-docker"></a> Install docker
---

<SmallTerminal data={dockerInstallation} height={'32px'}/>
...
<SmallTerminal data={cloneProject} height={'32px'}/>
...
<SmallTerminal data={buildProject} height={'16px'}/>
...
<SmallTerminal data={testProject} height={'16px'}/>
