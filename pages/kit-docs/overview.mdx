...
Drizzle Kit lets you alter you database schema and rapidly move forward with a db [`push` command](./commands/push).  
...
```
For extended `push` examples - [see here](./commands/push)
...
For extended `introspect` examples - [see here](./commands/pull)
