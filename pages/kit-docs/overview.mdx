...
# Drizzle Kit
Our most fundamental design principle of Drizzle ORM is to always stay explicit, 
...
You can rapidly prototype a database schema and push it directly to the database.
...
Each SQL migration file contains statements which you apply to the database through the Drizzle ORM migration package or any other way suitable for your business case or personal preference.
...
it will generate the SQL migration for you completely automatically in most cases.
...
We provide you a useful way to run generated migrations with the `migrate` function which we implement for each driver and dialect specifically.  
...
For a list of all configuration params — **[see here.](./conf)**
