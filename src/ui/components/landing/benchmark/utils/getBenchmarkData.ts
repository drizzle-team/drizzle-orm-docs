...
const variants = [
  {
    ...
    database: "postgres",
    runtime: "bun-1.3.13-bun-sql",
    joins: false,
    drizzleData: data["30042026:drizzle-bun-jit"],
  ...
  },
  {
    ...
    projectType: "ecommerce",
    database: "postgres",
    runtime: "bun-1.3.13-node-pg",
    joins: false,
    drizzleData: data["30042026:drizzle-bun-pg-jit"],
    compareData: data["30042026:go"],
  },
  {
    orm: "go-20260430-default",
    dbSize: "micro",
    projectType: "ecommerce",
    database: "postgres",
    runtime: "bun-1.3.13-bun-sql",
    joins: false,
    drizzleData: data["30042026:drizzle-bun-default"],
    compareData: data["30042026:go"],
  },
  {
    orm: "go-20260430-default",
    ...
    runtime: "bun-1.3.13-node-pg",
    joins: false,
    drizzleData: data["30042026:drizzle-bun-pg"],
    compareData: data["30042026:go"],
  },
  {
    ...
    joins: false,
    drizzleData: data["30042026:drizzle-bun-jit"],
    compareData: data["30042026:prisma-bun"],
  },
  {
    orm: "go",
    dbSize: "micro",
