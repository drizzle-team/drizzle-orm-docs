---
title: "Todo App with Drizzle ORM, Next.js and Neon"
...
This guide uses the following file structure for Backend part:
```text
📦 <project root>
 ├ 📂 drizzle
 │  ├ 📂 meta
...
This guide uses the following file structure for Frontend part:
```text
📦 <project root>
 ├ 📂 actions
 │  └ 📜 todoActions.ts
