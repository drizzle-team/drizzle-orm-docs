...
pubDate: 2023-11-09
description: Added new features like unsigned option for bigint in MySQL, improved query builder types, added possibility to specify name for primary keys and foreign keys, read replicas support, set operators support (UNION, UNION ALL, INTERSECT, INTERSECT ALL, EXCEPT, EXCEPT ALL), new MySQL and PostgreSQL proxy drivers, D1 Batch API support.
---
