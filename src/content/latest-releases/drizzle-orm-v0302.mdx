...
To get started with Turso and Drizzle follow the [documentation](https://orm.drizzle.team/docs/get-started-sqlite#turso)

## Fixes

- [Sqlite] Fix findFirst query for bun:sqlite ([#1885](https://github.com/drizzle-team/drizzle-orm/pull/1885))

To get started with Bun SQLite and Drizzle follow the [documentation](https://orm.drizzle.team/docs/get-started-sqlite#bun-sqlite)
