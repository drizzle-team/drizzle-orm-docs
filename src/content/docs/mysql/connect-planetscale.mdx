...
For PlanetScale Postgres, see the [PlanetScale Postgres connection guide](/docs/pg/connect-planetscale-postgres).
...
You can also access PlanetScale MySQL through TCP with `mysql2` driver — **[see here.](/docs/mysql/get-started-mysql)**
