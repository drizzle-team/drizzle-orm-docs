...
RQBv1 has been removed. Use [Relational Queries v2](/docs/mysql/relations-v2) with the new `defineRelations()` API instead. You can find more details about migrating from rqb v1 to v2 [here](/docs/mysql/relations-v1-v2)
