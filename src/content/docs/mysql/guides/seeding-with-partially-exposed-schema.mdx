...
export const bloodPressure = mysqlTable("bloodPressure", {
	bloodPressureId: int().primaryKey().autoincrement(),
	pressure: double(),
...
```
- You can [refine](/docs/mysql/guides/seeding-with-partially-exposed-schema#refining-the-userid-column-generator) the `userId` column generator;
...
- Otherwise, you can [refine](/docs/mysql/guides/seeding-with-partially-exposed-schema#refining-the-userid-column-generator) the `userId` column generator. 
