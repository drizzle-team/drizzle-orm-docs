...
- [Select statement](/docs/mysql/select) and [select from subquery](/docs/mysql/select#select-from-subquery)
- [Inner join](/docs/mysql/joins#inner-join)
- [Filter operators](/docs/mysql/operators) and [exists function](/docs/mysql/operators#exists)
</Prerequisites>
