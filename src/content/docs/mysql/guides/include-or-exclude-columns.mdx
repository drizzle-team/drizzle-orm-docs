...
- [Get typed table columns](/docs/mysql/goodies#get-typed-columns)
- [Joins](/docs/mysql/joins)
- [Relational queries](/docs/mysql/rqb)
- [Partial select with relational queries](/docs/mysql/rqb#partial-fields-select)
</Prerequisites>
