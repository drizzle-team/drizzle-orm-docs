...
- [Select statement](/docs/mysql/select) with [order by clause](/docs/mysql/select#order-by) and [limit & offset clauses](/docs/mysql/select#limit--offset)
- [Relational queries](/docs/mysql/rqb) with [order by clause](/docs/mysql/rqb#order-by) and [limit & offset clauses](/docs/mysql/rqb#limit--offset)
- [Dynamic query building](/docs/mysql/dynamic-query-building)
</Prerequisites>
...
So, if your database experiences frequently insert and delete operations in real time or you need high performance to paginate large tables, you should consider using [cursor-based](/docs/mysql/guides/cursor-based-pagination) pagination instead.
