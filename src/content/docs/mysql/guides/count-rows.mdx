...
Drizzle has simple and flexible API, which lets you create your custom solutions. In MySQL `count()` function returns bigint, which is interpreted as string by the driver, so it should be casted to unsigned integer:
