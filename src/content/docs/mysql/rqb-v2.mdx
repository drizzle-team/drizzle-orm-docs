...
<CodeTabs items={["index.ts", "schema.ts"]}>
    ...
    export const posts = t.mysqlTable("posts", {
...
<Callout type="info" emoji="ℹ️">
	`drizzle` import path depends on the **[database driver](/docs/mysql/connect-overview)** you're using.
</Callout>
...
```typescript copy
import { type AnyMySqlColumn, boolean, int, mysqlTable, primaryKey, text, timestamp } from 'drizzle-orm/mysql-core';
...
### Prepared statements
Prepared statements are designed to massively improve query performance — [see here.](/docs/mysql/perf-queries)
