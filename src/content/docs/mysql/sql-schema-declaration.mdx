...
there is no such thing as a common table object in Drizzle. You need to choose the MySQL table object.
...
<Flex>
  <LinksList 
    title='Manage schema'
    links={[
        ["Column types", "/docs/mysql/column-types"], 
        ["Indexes and Constraints", "/docs/mysql/indexes-constraints"],
        ["Database Views", "/docs/mysql/views"],
        ["Database Schemas", "/docs/mysql/schemas"],
      ]}
  />
  <LinksList 
    title='Zero to Hero'
    links={[
        ["Database connection", "/docs/mysql/connect-overview"], 
        ["Data querying", "/docs/mysql/data-querying"], 
        ["Migrations", "/docs/mysql/migrations"], 
      ]}
  />
</Flex>
