...
**It's the only ORM with both [relational](/docs/mysql/rqb-v2) and [SQL-like](/docs/mysql/select) query APIs**, 
...
**[automatic migrations](/docs/mysql/migrations)** and **[one more thing](/docs/mysql/rqb-v2)**. ✨
...
We've built the **[Queries API](/docs/mysql/rqb-v2)** for you, so you can fetch relational nested data from the database 
