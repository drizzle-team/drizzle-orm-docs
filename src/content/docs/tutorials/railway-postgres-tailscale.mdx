...
<Callout type="info">
If you also want a database UI on your tailnet, start with [Drizzle Studio and Gateway on Railway with Tailscale](/docs/tutorials/railway-studio-tailscale). Its templates come with the same Tailscale service.
</Callout>
...
- [Drizzle Studio and Gateway on Railway with Tailscale](/docs/tutorials/railway-studio-tailscale) to browse the database from your tailnet.
