...
On the project canvas, click the `New` button in the top right corner and select `Database` → `PostgreSQL`. You can also use the command palette (<Shortcut mac="⌘ K" other="Ctrl K" />) and search for PostgreSQL. Railway will provision a new PostgreSQL instance for you.
...
![](@/assets/images/tutorials/railway-add-public-access.png)
...
![](@/assets/images/tutorials/railway-add-public-access-apply.png)
...
You can deploy [Drizzle Studio](/drizzle-studio/overview) alongside your application on Railway to browse and manage your database directly from the browser.
...
![](@/assets/images/tutorials/railway-deploy-drizzle-studio-project.png)
...
<details>
<summary style="cursor: pointer; user-select: none; margin-bottom: 16px;">Show the manual steps</summary>
