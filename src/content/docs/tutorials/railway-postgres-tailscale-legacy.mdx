---
title: "Connect Drizzle Kit to a private Railway database with Tailscale (legacy)"
date: "2026-08-27"
---
...
Drizzle now has a Railway template that adds a Tailscale service to your project. You click one sign-in link in its deploy log, and every device on your tailnet reaches the database. To connect `drizzle-kit` that way, follow [Connect Drizzle Kit to a private Railway database with Tailscale](/docs/tutorials/railway-postgres-tailscale). For a database browser on your tailnet, follow [Drizzle Studio and Gateway on Railway with Tailscale](/docs/tutorials/railway-studio-tailscale).
</Callout>
