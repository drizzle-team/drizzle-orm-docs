...
Drizzle now has a Railway template that includes its own Tailscale forwarder, which makes the setup simpler. Follow the latest version of this guide: [Connect Drizzle Kit to a private Railway database with Tailscale](/docs/tutorials/railway-postgres-tailscale).
</Callout>
