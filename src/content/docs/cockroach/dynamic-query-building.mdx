...
<table>
	...
	<tbody>
		<tr align='center'>
			<td rowspan='2'>CockroachDB</td>
			<td>
				<code>CockroachSelect</code>
			</td>
			<td rowspan='2'>
				<code>CockroachInsert</code>
			</td>
			<td rowspan='2'>
				<code>CockroachUpdate</code>
			</td>
			<td rowspan='2'>
				<code>CockroachDelete</code>
			</td>
		</tr>
		<tr align='center'>
			<td>
				<code>CockroachSelectQueryBuilder</code>
			</td>
		</tr>
	</tbody>
</table>
