...
<CodeTabs items={["import-pattern", "builder-pattern", "schema.ts"]}>
    ...
    <CodeTab>
	```typescript copy
    import { integer, cockroachTable, text, varchar } from "drizzle-orm/cockroach-core";
...
<CodeTabs items={["import-pattern", "builder-pattern", "schema.ts"]}>
    ...
    <CodeTab>
	```typescript copy
    import { integer, cockroachTable, text, timestamp, varchar } from "drizzle-orm/cockroach-core";
