...
- [Select statement](/docs/cockroach/select) and [select from subquery](/docs/cockroach/select#select-from-subquery)
- [Inner join](/docs/cockroach/joins#inner-join)
- [Filter operators](/docs/cockroach/operators) and [exists function](/docs/cockroach/operators#exists)
</Prerequisites>
