...
<Section>
    ...
    import { integer, uuid, cockroachTable } from "drizzle-orm/cockroach-core";
...
<Section>
      ```typescript copy
      import { integer, cockroachTable } from "drizzle-orm/cockroach-core";
...
<Section>
      ```typescript copy
      import { integer, text, unique, cockroachTable } from "drizzle-orm/cockroach-core";
      ...
      export const userNulls = cockroachTable('user_nulls_example', {
...
<Section>
      ```typescript copy
      import { sql } from "drizzle-orm";
      import { check, integer, cockroachTable, text, uuid } from "drizzle-orm/cockroach-core";
...
<Section>
      ```typescript copy
      import { serial, text, cockroachTable } from "drizzle-orm/cockroach-core";
...
<Section>
      ...
      import { serial, text, integer, primaryKey, cockroachTable } from "drizzle-orm/cockroach-core";
...
```typescript copy {11}
    import { serial, text, integer, cockroachTable } from "drizzle-orm/cockroach-core";
...
```typescript copy {6,16-19}
    import { serial, text, integer, foreignKey, cockroachTable, AnyPgColumn } from "drizzle-orm/cockroach-core";
...
```typescript copy {4-5,14-15,18-21}
    import { serial, text, foreignKey, cockroachTable, AnyPgColumn } from "drizzle-orm/cockroach-core";
...
<Section>
    ...
    import { serial, text, index, uniqueIndex, cockroachTable } from "drizzle-orm/cockroach-core";
