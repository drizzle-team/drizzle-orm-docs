...
```ts filename="schema.ts"
import { cockroachTable, integer, text, varchar, doublePrecision } from "drizzle-orm/cockroach-core";
...
<Section>
```ts
import type { AnyPgColumn } from "drizzle-orm/cockroach-core";
import { integer, numeric, cockroachTable, text, timestamp, varchar } from "drizzle-orm/cockroach-core";
