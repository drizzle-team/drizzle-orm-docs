...
```typescript
import { sql } from "drizzle-orm";
import { integer, cockroachTable, uuid } from "drizzle-orm/cockroach-core";
...
```ts
import { integer, timestamp, text, cockroachTable } from "drizzle-orm/cockroach-core";
...
<Section>
```typescript
import { serial, cockroachTable } from "drizzle-orm/cockroach-core";
