...
```shell
npx drizzle-kit pull --dialect=cockroach --url=cockroach://user:password@host:port/dbname
```
</CodeTabs>
...
<Npx>
drizzle-kit pull --dialect=cockroach --url=cockroach://user:password@host:port/dbname
drizzle-kit pull --dialect=cockroach --driver=pglite url=database/
drizzle-kit pull --dialect=cockroach --tablesFilter='user*' --extensionsFilters=postgis url=cockroach://user:password@host:port/dbname
</Npx>
