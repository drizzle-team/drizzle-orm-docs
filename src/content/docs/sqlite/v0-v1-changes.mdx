...
RQBv1 has been removed. Use [Relational Queries v2](/docs/sqlite/relations) with the new `defineRelations()` API instead and new features. You can find more details about migrating from rqb v1 to v2 [here](/docs/sqlite/relations-v1-v2)
