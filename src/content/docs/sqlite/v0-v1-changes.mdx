...
`drizzle-kit generate` now identifies [incompatible changes](/docs/sqlite/v0-v1-changes#drizzle-kit-check--commutativity-check) across migration branches. Use `--ignore-conflicts` to bypass.
