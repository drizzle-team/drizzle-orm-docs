...
**It's the only ORM with both [relational](/docs/sqlite/rqb) and [SQL-like](/docs/sqlite/select) query APIs**, 
...
**[automatic migrations](/docs/sqlite/migrations)** and **[one more thing](/docs/sqlite/rqb)**. ✨
...
We've built the **[Queries API](/docs/sqlite/rqb)** for you, so you can fetch relational nested data from the database 
