...
**It's the only ORM with both [relational](/docs/sqlite/rqb-v2) and [SQL-like](/docs/sqlite/select) query APIs**, 
...
We bring all the familiar **[SQL schema](/docs/sqlite/sql-schema-declaration)**, **[queries](/docs/sqlite/select)**, 
**[automatic migrations](/docs/sqlite/migrations)** and **[one more thing](/docs/sqlite/rqb-v2)**. ✨
...
We've built the **[Queries API](/docs/sqlite/rqb-v2)** for you, so you can fetch relational nested data from the database 
