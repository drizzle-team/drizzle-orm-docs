...
<Prerequisites>
  - How to define your schema - [Schema Fundamentals](/docs/sqlite/sql-schema-declaration)
  - How to connect to the database - [Connection Fundamentals](/docs/sqlite/connect-overview)
</Prerequisites>
...
<Flex>
  <LinksList 
    ...
    links={[
        ["Query", "/docs/sqlite/rqb-v2"], 
        ["Select", "/docs/sqlite/select"],
        ["Insert", "/docs/sqlite/insert"],
        ["Update", "/docs/sqlite/update"],
        ["Delete", "/docs/sqlite/delete"],
        ["Filters", "/docs/sqlite/operators"],
