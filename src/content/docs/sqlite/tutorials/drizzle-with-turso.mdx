...
<Prerequisites>
- You should have installed Drizzle ORM and [Drizzle kit](/docs/sqlite/kit-overview). You can do this by running the following command:
<Npm>
  drizzle-orm@rc
  -D drizzle-kit@rc
</Npm>
...
**Drizzle config** - a configuration file that is used by [Drizzle Kit](/docs/sqlite/kit-overview) and contains all the information about your database connection, migration folder and schema files.
...
Alternatively, you can push changes directly to the database using [Drizzle kit push command](/docs/sqlite/drizzle-kit-push):
...
📦 <project root>
 ...
 │   │  └ 📜 schema.ts
 ├ 📂 migrations
 │  └ 📂 20260709074133_gifted_rawhide_kid
 │     ├ 📜 migration.sql
 │     └ 📜 snapshot.json
 ├ 📜 .env
 ├ 📜 drizzle.config.ts
...
Read more about insert query in the [documentation](/docs/sqlite/insert).
...
Read more about select query in the [documentation](/docs/sqlite/select).
...
Alternatively, you can use [relational query syntax](/docs/sqlite/rqb).

#### Update data

Read more about update query in the [documentation](/docs/sqlite/update).
...
Read more about delete query in the [documentation](/docs/sqlite/delete).
