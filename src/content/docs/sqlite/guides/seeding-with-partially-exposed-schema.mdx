...
export const bloodPressure = sqliteTable("bloodPressure", {
	bloodPressureId: integer().primaryKey({ autoIncrement: true }),
	pressure: real(),
...
```
- You can [refine](/docs/sqlite/guides/seeding-with-partially-exposed-schema#refining-the-userid-column-generator) the `userId` column generator;
...
- Otherwise, you can [refine](/docs/sqlite/guides/seeding-with-partially-exposed-schema#refining-the-userid-column-generator) the `userId` column generator. 
