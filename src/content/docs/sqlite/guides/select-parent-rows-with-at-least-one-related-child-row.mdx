...
- [Select statement](/docs/sqlite/select) and [select from subquery](/docs/sqlite/select#select-from-subquery)
- [Inner join](/docs/sqlite/joins#inner-join)
- [Filter operators](/docs/sqlite/operators) and [exists function](/docs/sqlite/operators#exists)
</Prerequisites>
