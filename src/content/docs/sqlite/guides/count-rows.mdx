...
- [Filters](/docs/sqlite/operators) and [sql operator](/docs/sqlite/sql)
- [Aggregations](/docs/sqlite/select#aggregations) and [Aggregation helpers](/docs/sqlite/select#aggregations-helpers)
...
In SQLite, `count()` result returns as integer, so you don't need to cast it. Drizzle has simple and flexible API, which lets you create your custom solutions:
