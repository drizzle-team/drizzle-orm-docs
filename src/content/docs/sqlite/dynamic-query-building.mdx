...
This is possible, because `SQLiteSelect` and other similar types are specifically designed to be used in dynamic query building. They can only be used in dynamic mode.
...
<Callout type='info'>
	...
	instances](/docs/sqlite/goodies#standalone-query-builder). DB query builders are
