...
documentation available at **[Core API docs](/docs/sqlite/select#basic-and-partial-select)**.

**Select different custom fields from table**

Here you can see a usage for **[`sql<T>`](/docs/sqlite/sql#sqlt)**, **[`sql``.mapWith()`](/docs/sqlite/sql#sqlmapwith)**, **[`sql``.as<T>()`](/docs/sqlite/sql#sqlast)**.
