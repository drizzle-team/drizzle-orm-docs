...
- [Drizzle Kit](/docs/sqlite/kit-overview) support for migration generation and bundling in application ✅
...
Please make sure to check how [Drizzle migrations](/docs/sqlite/kit-overview) work before proceeding.  
...
You can run migrations on application startup using our custom `useMigrations` migrations hook or in a `useEffect` hook manually as you want.
