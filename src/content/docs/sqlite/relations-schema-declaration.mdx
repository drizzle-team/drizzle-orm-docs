...
CREATE TABLE Customers_Unnormalized (
    ...
    name TEXT,
    address TEXT -- Problem: Multiple pieces of info in one column
);
...
CREATE TABLE suppliers (
    supplier_id TEXT PRIMARY KEY,
    supplier_name TEXT,
    zip_code TEXT, -- Foreign Key to zip_codes
...
CREATE TABLE enrollments (
    id INTEGER PRIMARY KEY AUTOINCREMENT, -- Optional, but good practice for junction tables
    student_id INTEGER,
    course_id INTEGER,
