...
We have native support for all of them, yet if that's not enough for you, feel free to create **[custom types](/docs/sqlite/custom-types)**.
...
You can use database aliases in column names if you want. You can use database aliases in column names if you want, and you can also use the `casing API` to define a mapping strategy for Drizzle.
You can read more about it [here](/docs/sqlite/sql-schema-declaration#shape-your-data-schema)
