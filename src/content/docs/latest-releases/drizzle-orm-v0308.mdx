...
Learn more about Postgres [schemas](/docs/schemas) and [enums](/docs/column-types#enum).

## Fixes

- Changed D1 `migrate()` function to use batch API ([#2137](https://github.com/drizzle-team/drizzle-orm/pull/2137))

To get started with Drizzle and D1 follow the [documentation](/docs/sqlite/get-started-sqlite#cloudflare-d1).
