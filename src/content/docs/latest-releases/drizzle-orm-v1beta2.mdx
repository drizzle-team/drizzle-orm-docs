...
> Check new RQBv2 schema docs: https://orm.drizzle.team/docs/relations

> Check new RQBv2 query docs: https://orm.drizzle.team/docs/rqb
...
- blob: https://orm.drizzle.team/docs/mysql/column-types#blob
- tinyblob: https://orm.drizzle.team/docs/mysql/column-types#tinyblob
- mediumblob: https://orm.drizzle.team/docs/mysql/column-types#mediumblob
- longblob: https://orm.drizzle.team/docs/mysql/column-types#longblob
