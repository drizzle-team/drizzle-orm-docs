...
- [Aggregations](/docs/mssql/select#aggregations) and [Aggregation helpers](/docs/mssql/select#aggregations-helpers)
...
In MSSQL, `count()` result returns as integer, so you don't need to cast it. Drizzle has simple and flexible API, which lets you create your custom solutions:
