...
- [Select statement](/docs/mssql/select) and [select from subquery](/docs/mssql/select#select-from-subquery)
- [Inner join](/docs/mssql/joins#inner-join)
- [Filter operators](/docs/mssql/operators) and [exists function](/docs/mssql/operators#exists)
</Prerequisites>
