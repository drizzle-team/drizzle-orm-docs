...
It's required whenever we introduce breaking changes to the text snapshots of the schema and upgrade the internal version.
...
|           |            |                                                                         |
| :-------- | :--------- | :---------------------------------------------------------------------- |
| `dialect` | `required` | Database dialect you are using. Can be `postgresql`, `mssql`, `sqlite`, or `singlestore` |
