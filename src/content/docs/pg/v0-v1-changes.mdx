...
RQBv1 has been removed. Use [Relational Queries v2](/docs/relations-v2) with the new `defineRelations()` API instead. You can find more details about migrating from rqb v1 to v2 [here](/docs/relations-v1-v2)
