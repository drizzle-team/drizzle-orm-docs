...
- You should have installed the `postgres` package as the PostgreSQL driver. Read more about it [here](https://www.npmjs.com/package/postgres)
<Npm>
  postgres
</Npm>
...
{
  "imports": {
    "drizzle-orm/": "https://esm.sh/drizzle-orm@rc/",
...
In this tutorial we will use Drizzle kit to push changes to the Supabase database.
...
Open your browser and navigate to the route `/user`. You should see the user data returned from the Supabase database:
