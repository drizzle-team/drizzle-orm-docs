...
<Prerequisites>
  ...
  - You should have installed `pg` package for applying migrations through `drizzle`. Read more about this package [here](https://www.npmjs.com/package/pg)
  <Npm>
      pg
      -D @types/pg
  </Npm>
...
You can create a new Encore project:
