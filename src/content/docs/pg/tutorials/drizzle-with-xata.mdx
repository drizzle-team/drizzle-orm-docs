...
📦 <project root>
 ...
 │      └ 📜 schema.ts
 ├ 📂 migrations
 │   └ 📂 20260708121811_quick_frightful_four
 │      ├ 📜 migration.sql
 │      └ 📜 snapshot.json
 ├ 📜 .env
 ├ 📜 drizzle.config.ts
