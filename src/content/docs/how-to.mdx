...
It's releasing by the `beta.x` pattern meaning you'll see versions `1.0.0-beta.7`, `1.0.0-beta.8` and so on. Release notes
for each beta update will be available in the [GitHub releases](https://github.com/drizzle-team/drizzle-orm/tags)
...
We've explained in details all the changes for RQBv2 together with different option on how to update your codebase:
