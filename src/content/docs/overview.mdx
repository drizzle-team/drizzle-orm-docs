...
**It's the only ORM with both [relational](/docs/rqb-v2) and [SQL-like](/docs/select) query APIs**, 
...
**[automatic migrations](/docs/migrations)** and **[one more thing](/docs/rqb-v2)**. ✨
...
We've built the **[Queries API](/docs/rqb-v2)** for you, so you can fetch relational nested data from the database 
...
Now go build something awesome with Drizzle and your **[PostgreSQL](/docs/get-started-postgresql)**, **[MySQL](/docs/mysql/get-started-mysql)** or **[SQLite](/docs/sqlite/get-started-sqlite)** database. 🚀
