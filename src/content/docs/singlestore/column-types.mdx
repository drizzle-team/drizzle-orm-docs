...
We have native support for all of them, yet if that's not enough for you, feel free to create **[custom types](/docs/singlestore/custom-types)**.
...
You can read more about it [here](/docs/singlestore/sql-schema-declaration#shape-your-data-schema)
</Callout>
