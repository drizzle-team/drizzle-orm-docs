...
We've built [**drizzle-kit**](/docs/singlestore/kit-overview) - CLI app for managing migrations with Drizzle. 
```shell
drizzle-kit migrate
...
Drizzle lets you pull database schema to TypeScript using [`drizzle-kit pull`](/docs/singlestore/drizzle-kit-pull) command.
...
Drizzle lets you push schema changes to the database using [`drizzle-kit push`](/docs/singlestore/drizzle-kit-push) command.
...
<Callout collapsed="Expand details">
That's a **codebase first** approach. You have your TypeScript Drizzle schema as a source of truth and 
Drizzle lets you generate SQL migration files based on your schema changes with [`drizzle-kit generate`](/docs/singlestore/drizzle-kit-generate)
and then apply them to the database with [`drizzle-kit migrate`](/docs/singlestore/drizzle-kit-migrate) commands. 
<Section>
...
<Callout collapsed="Expand details">
That's a **codebase first** approach. You have your TypeScript Drizzle schema as a source of truth and 
Drizzle lets you generate SQL migration files based on your schema changes with [`drizzle-kit generate`](/docs/singlestore/drizzle-kit-generate) and then 
...
<Callout collapsed="Expand details">
That's a **codebase first** approach. You have your TypeScript Drizzle schema as a source of truth and 
Drizzle lets you export SQL statements based on your schema changes with [`drizzle-kit export`](/docs/singlestore/drizzle-kit-generate) and then 
