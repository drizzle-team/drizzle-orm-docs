...
documentation available at **[Core API docs](/docs/singlestore/select#basic-and-partial-select)**.

**Select different custom fields from table**

Here you can see a usage for **[`sql<T>`](/docs/singlestore/sql#sqlt)**, **[`sql``.mapWith()`](/docs/singlestore/sql#sqlmapwith)**, **[`sql``.as<T>()`](/docs/singlestore/sql#sqlast)**.
