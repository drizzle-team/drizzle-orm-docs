...
<IsSupportedChipGroup chips={{ 'PostgreSQL': true, 'SQLite': true, 'MySQL': true, 'SingleStore': false, 'MSSQL': true}} />
...
### Declaring views
<Tabs items={['PostgreSQL', 'MySQL', 'SQLite', 'MSSQL']}>
  <Tab>
    <Section>
...
### Materialized views
<IsSupportedChipGroup chips={{ 'PostgreSQL': true, 'MySQL': false, 'SQLite': false, 'MSSQL': false }} />
