...
Value is like other value, case sensitive (in SQLite - [case insensitive for ASCII characters](https://www.sqlite.org/lang_expr.html#the_like_glob_regexp_match_and_extract_operators))
<Section>
```typescript
