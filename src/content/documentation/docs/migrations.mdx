...
# Drizzle migrations foundamentals
...
It fits in both database and codebase first approaches, it let's you **push schema** or **generate SQL migrations** files or **pull schema** from database. 
It is perfect for you to work alone or in the team.
<br/>
...
> I manage database schema myself using external migration tools or running SQL migrations directly on my database.
> From Drizzle I just need to fetch it from my database and save it as TypeScript schema
...
> I want to have database schema in my TypeScript codebase, 
> I wan't Drizzle to generate SQL migration files for me and apply them to my database
...
> I want to have database schema in my TypeScript codebase,
> I wan't Drizzle to generate SQL migration files for me and I want Drizzle to apply them during runtime
...
This approach is widely used for **monolythic** applications when you apply database migrations 
...
> I want to have database schema in my TypeScript codebase,
> I wan't Drizzle to generate SQL migration files for me,
