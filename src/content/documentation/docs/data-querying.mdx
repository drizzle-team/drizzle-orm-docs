...
- you know how to define your schema and have a first example
- you chose your way to connect to the database
- now let's check how we can seed you database, query it in a few different ways and what way to choose
...
It can be qither SQL-like syntax or Relational Syntax. Let's check them:
