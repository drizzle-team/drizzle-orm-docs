...
The Neon serverless driver is not supported with [Drizzle Kit](/kit-docs/overview). For Drizzle Kit, use a standard Postgres driver like **[`postgres`](#postgresjs)** or **[`pg`](#node-postgres)**.
</Callout>
