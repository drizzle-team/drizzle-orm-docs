...
According their **[official website](https://xata.io)**, Xata is a Postgres data platform with a focus on reliability, scalability, and developer experience.

Drizzle ORM natively supports `xata` driver with `drizzle-orm/xata` package and the **[`postgres`](#postgresjs)** or **[`pg`](#node-postgres)** drivers for accessing a Xata Postgres database.

<Npm>
drizzle-orm @xata.io/drizzle @xata.io/client
-D drizzle-kit
</Npm>
