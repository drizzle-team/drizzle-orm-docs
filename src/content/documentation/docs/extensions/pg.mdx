...
<Callout type="info">
If you are using the `introspect` or `push` commands with the PostGIS extension and don't want PostGIS tables to be included, you can use [`extensionsFilters`](/kit-docs/config-reference#extensionsfilters) to ignore all the PostGIS tables
</Callout>
