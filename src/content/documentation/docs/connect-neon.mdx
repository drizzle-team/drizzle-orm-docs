...
You can connect to a Neon database directly using either [Postgres](/docs/get-started-postgresql#postgresjs) or [Node-Postgres](/docs/get-started-postgresql/#node-postgres).
