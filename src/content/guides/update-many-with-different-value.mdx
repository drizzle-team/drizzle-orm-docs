...
To implement update many with different value for each row within 1 request you can use `sql` operator with `case` statement and `.update().set()` methods like this:
