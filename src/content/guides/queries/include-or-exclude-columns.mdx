...
- [Get typed table columns](https://orm.drizzle.team/docs/goodies#get-typed-table-columns)
- [Relational queries](https://orm.drizzle.team/docs/rqb)
- [Partial select with relational queries](https://orm.drizzle.team/docs/rqb#partial-fields-select)
</Prerequisites>
